...
let StrenghtText = document.querySelector("#strengthText");
...
function calcStrength() {
  ...
  if (hasUpper && hasLower && (hasNumber || hasSymbol) && passwordLength >= 8) {
    ...
    setIndicator("#ff0");
    StrenghtText.innerText = "Average😐";
    StrenghtText.style.color = "#ff0";
  } else {
    setIndicator("#f00");
    StrenghtText.innerText = "Weak🤦‍♂️";
    StrenghtText.style.color = "#f00";
  }
}
